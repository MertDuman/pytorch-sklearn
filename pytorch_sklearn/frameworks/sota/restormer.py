...
##########################################################################
##---------- Restormer -----------------------
# Parameters of the best model from GitHub:
# type: Restormer
# inp_channels: 3
# out_channels: 3
# dim: 48
...
#     dual_pixel_task = False
# )
# __restormer_state_dict = torch.load('weights.pth', map_location='cpu')
# __restormer.load_state_dict(__restormer_state_dict['params'])
...
class Restormer(nn.Module):
    def __init__(self,
        ...
        self.encoder_level1 = nn.Sequential(
            *[TransformerBlock(dim=dim, num_heads=heads[0], ffn_expansion_factor=ffn_expansion_factor, bias=bias, LayerNorm_type=LayerNorm_type) for i in
              range(num_blocks[0])])
